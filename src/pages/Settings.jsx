...
import { User, Bell, Shield, Paintbrush, Database, Sparkles, LogOut, Command, Zap, Volume2, Globe, Moon } from "lucide-react";
...
function NeuralToggle({ enabled, onToggle, color = "#00F5D4" }) {
  return (
    <button
      onClick={onToggle}
...
function NeuralSlider({ value, onChange, min = 1, max = 3, labels, color = "#FF8A00" }) {
